...
export default function MoviesPage() {
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-8">
      <Panel title="MOVIES" accent="green">
        ...
        {movies.length === 0 ? (
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {movies.map((movie) => (
              ...
              >
                <div className="rounded border border-terminal-border bg-terminal-black p-4 transition-all duration-200 hover:border-bloomberg-green/50">
                  ...
                  <h3 className="font-mono text-sm font-medium text-terminal-text transition-colors group-hover:text-bloomberg-green">
